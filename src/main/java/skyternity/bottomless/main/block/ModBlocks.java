...
import skyternity.bottomless.main.item.EnchGammastoneItem;
...
public class ModBlocks {
    ...
    public static final RegistryObject<Block> POROUS_SHADESTONE = registerWithItem("porous_shadestone", () -> new Block(AbstractBlock.Properties.of(Material.STONE).sound(SoundType.STONE).strength(50.0f, 1200.0f).harvestTool(ToolType.PICKAXE).harvestLevel(4)), new Item.Properties().tab(BottomlessMod.MAIN_BOTTOMLESS_TAB));
