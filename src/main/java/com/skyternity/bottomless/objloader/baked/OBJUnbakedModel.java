package com.skyternity.bottomless.objloader.baked;

import com.mojang.datafixers.util.Pair;
import com.skyternity.bottomless.objloader.mtlloader;
...
public class OBJUnbakedModel implements UnbakedModel {
    ...
    private final Map<String, mtlloader> mtls;
    private final ModelTransformation transform;
    private final SpriteIdentifier sprite;

    public OBJUnbakedModel(Obj obj, Map<String, mtlloader> mtls, ModelTransformation transform) {
        this.obj = obj;
        this.mtls = mtls;
    ...
    private mtlloader findMtlForName(String name) {
    ...
    public BakedModel bake(ModelLoader loader, Function<SpriteIdentifier, Sprite> textureGetter, ModelBakeSettings bakeSettings, Identifier modelId) {
        ...
        if (renderer != null) {
            ...
            for (Map.Entry<String, Obj> entry : materialGroups.entrySet()) {
                ...
                mtlloader mtl = findMtlForName(matName);
                int color = -1;
